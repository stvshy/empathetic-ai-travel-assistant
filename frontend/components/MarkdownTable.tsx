...
export const Table: React.FC<TableProps> = ({ children }) => (
  <div className="my-4 overflow-x-auto max-w-full rounded-lg border border-gray-200 shadow-sm">
...
export const TableCell: React.FC<TableCellProps> = ({ children, isHeader = false }) => {
  if (isHeader) {
    return (
      <th
        className="px-3 py-2.5 text-left text-xs font-semibold text-gray-700 border-r border-gray-200 last:border-r-0 bg-blue-50/50 break-words"
  ...
  return (
    <td
      className="px-3 py-2.5 text-xs text-gray-700 border-r border-gray-100 last:border-r-0 break-words align-top"
      style={{ overflowWrap: "anywhere", wordBreak: "break-word" }}
    >
      {children}
    </td>
